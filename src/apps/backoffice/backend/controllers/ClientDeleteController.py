...
from src.contexts.backoffice.clients.application.delete_one.DeleteClientCommand import DeleteClientCommand
from src.contexts.backoffice.clients.infrastructure.ClientsHttpResponseErrorHandler import JsonResponseErrorHandler
...
class ClientDeleteController(BackofficeController):
